...
Public Class StaffAddBar
    Private Sub StaffAddBar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'MANAGE BARANG
        Call Koneksi()
    ...
    Private Sub btnAddBarang_Click(sender As Object, e As EventArgs) Handles btnAddBarang.Click
        ...
        Dim HargaBarang As String = txtHarga.Text.ToUpper
    ...
    Private Sub btnExitAdd_Click(sender As Object, e As EventArgs) Handles btnExitAdd.Click
        Me.Hide()
        StaffForm.Show()
        StaffForm.TampilBarang()
    End Sub

    Private Sub StaffAddBar_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
        StaffForm.TampilBarang()
    End Sub
End Class